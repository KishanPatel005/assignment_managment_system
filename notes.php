...
<div class="container py-4 py-lg-5">
    <div class="fables-blog my-3">
        <h2 class="fables-second-text-color mb-4 mb-lg-5 font-weight-bold"><?php echo "notes of $subject" ?></h2>

        <?php
        $sql = mysqli_query($con, "SELECT * FROM `notes` WHERE subjects_id = $subject_id ");
            ...
            while ($row = mysqli_fetch_assoc($sql)) {
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <a href="<?php echo $row['notes'] ?>" target="_blank" download>
